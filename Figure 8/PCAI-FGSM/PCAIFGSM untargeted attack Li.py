"""
The main function of this code file is to use the PCAI-FGSM to perform untargeted attacks and generate adversarial samples under the Li norm constraint.
...
for file_name in file_list:
    ...
    actual_image_index, x = predict_image_path(image_path, json_absolute_path, weights_path, 0, model_current)
    ...
    attack_image_index, x = predict_image_path(iterative_image_path, json_absolute_path, weights_absolute_path, actual_image_index, model_current)
    ...
    actual_image_top1_index, x = predict_image_path(image_path, json_absolute_path, weights_path, 0, model_current)
