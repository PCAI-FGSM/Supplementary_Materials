"""
The main function of this code file is to use the PCAI-FGSM to perform targeted attacks and generate adversarial samples under the L0 norm constraint.
...
Sixth, control the number of tampered pixels by setting the value of 'eps_L0'.
...
for file_name in file_list:
    ...
    atk = PCAIFGSM(model, alpha=0.001, steps=max_num_iterative, eps_L0=eps_L0)
    ...
    attack_image_index, x, _ = predict_image_path(iterative_image_path, json_absolute_path, weights_path, attack_index,
                                                  model_current)
