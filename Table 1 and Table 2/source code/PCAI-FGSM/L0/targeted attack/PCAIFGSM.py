...
Fourth, control the number of tampered pixels by setting the value of 'eps_L0' and 'delta'.
"""
...
class PCAIFGSM(Attack):
    def __init__(self, model, eps=255 / 255 * (2.4285 + 2.0357), alpha=1 / 255, steps=10, random_start=True, vcr=0.9, eps_L0=0.3):
