"""
The main function of this code file is to use the PCAI-FGSM to perform targeted attacks and generate adversarial samples under the L2 norm constraint.
...
Sixth, control the number of tampered pixels by setting the value of 'eps'.
...
for file_name in file_list:
    ...
    atk = PCAIFGSM(model, eps=eps, alpha=0.001, steps=max_num_iterative)
