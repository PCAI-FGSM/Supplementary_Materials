"""
The main function of this code file is to use the PCAI-FGSM to perform untargeted attacks and generate adversarial samples under the L2 norm constraint.
